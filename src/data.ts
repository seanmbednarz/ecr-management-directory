...
export const PEOPLE: Person[] = [
  ...
  { id: 'brandon-meadows', name: 'Brandon Meadows', cred: '', title: 'Building Engineer', dept: 'management', parent: 'mike-bartz',
    email: 'bmeadows@ecrtx.com', phone: '512-505-0943', mobile: '850-380-6299', linkedin: '',
    photo: '/Brandon_Meadows_-_Square.jpg', bio: BIO('brandon-meadows'), color: '#879792' },
  ...
  { id: 'melissa-saucedo', name: 'Melissa Saucedo', cred: '', title: 'Property Accountant', dept: 'management', parent: 'stephanie-trevino',
  ...
  { id: 'matthew-brimble', name: 'Matthew Brimble', cred: '', title: 'Property Accountant', dept: 'management', parent: 'stephanie-trevino',
    email: 'mbrimble@ecrtx.com', phone: '512-505-0886', mobile: '816-305-6667', linkedin: LI('matthew-brimble-774771bb'),
    photo: '/Matthew_Brimble_-_Square.jpg', bio: BIO('matthew-brimble'), color: '#879792' },
